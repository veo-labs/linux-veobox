...
/*1/4" CMOS QSXGA (5 megapixel) image sensor*/
...
static int ov5642_s_frame_interval(struct v4l2_subdev *sd,
				   struct v4l2_subdev_frame_interval *fi)
{
	struct ov5642_dev *sensor = to_ov5642_dev(sd);
	...
	ret = ov5642_change_mode(sensor, new_frame_rate, sensor->current_fr,
				  ...
				  struct v4l2_subdev_frame_size_enum *fse)
{
	...
	fse->min_width = ov5642_mode_info_data[0][fse->index].width;
	fse->max_width = ov5642_mode_info_data[0][fse->index].width;
	fse->min_height = ov5642_mode_info_data[0][fse->index].height;
	fse->max_height = ov5642_mode_info_data[0][fse->index].height;
			     ...
			     struct v4l2_subdev_format *format)
{
	...
	if (ret < 0 && sensor->current_fr == ov5642_30_fps) {
		ret = ov5642_change_mode(sensor,
					 ov5642_15_fps,
					 sensor->current_fr,
					 new_mode, sensor->current_mode);
...
static struct v4l2_subdev_video_ops ov5642_video_ops = {
	.s_frame_interval = ov5642_s_frame_interval,
